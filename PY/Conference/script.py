...
class SpiderSpider(scrapy.Spider):
    name = 'spider'
    allowed_domains = ['https://www.resurchify.com/e/all-events/all-categories/all-countries/all-years/page/6/?query=']
    start_urls = ['https://www.resurchify.com/e/all-events/all-categories/all-countries/all-years/page/6/?query=']
